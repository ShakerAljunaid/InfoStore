...
public class frmContacts extends javax.swing.JFrame {
   ...
   private ImageIcon ResizeImage(ImageIcon myimg,JLabel lbl)
    ...
    private void initComponents() {
        ...
        tblContact.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                tblContactKeyReleased(evt);
            }
        });
        ...
        getContentPane().add(jButton4, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 20, 18, 20));
 ...
 //call the method designated for adding row
    ...
    private void tblContactMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblContactMouseClicked
       int i = tblContact.getSelectedRow();
                   index=i+1    ; 
                   update_frame();
    ...
    private void tblContactKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tblContactKeyReleased
       int i = tblContact.getSelectedRow();
                   index=i+1    ; 
                   update_frame();
    }//GEN-LAST:event_tblContactKeyReleased
