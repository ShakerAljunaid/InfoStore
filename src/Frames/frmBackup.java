...
public class frmBackup extends javax.swing.JFrame {
        ...
        //To show the frame in center
         ...
         //To set the image of the frame
          this.setIconImage(new ImageIcon(getClass()
                    .getResource("/Pics/Icons/backup.gif")).getImage());
    }
    ...
    new Thread(new Runnable() {
      public void run() {
        ...
        for ( i= 0; i <= 100; i++) {
         ...
         //When done show msg informing the usr the backup was done
    ...
    {   
          ...
          String backupName=txtBackupName.getText() +"on("+dateFormat.format(CurrentDate)+")";
          
        try {
            Process exec = null;
          try {   //When we use the word --routine the entire db will be backuped ,when no only tables will.
              //exec = Runtime.getRuntime().exec("/C:/wamp/bin/mysql/mysql5.5.24/bin/mysqldump -u"+userName+" -p"+userPassword +" info_store -r "+backupPath+"/"+backupName+".sql");
              exec = Runtime.getRuntime().exec("/C:/wamp/bin/mysql/mysql5.5.24/bin/mysqldump -u"+userName+" -p"+userPassword +" --routines info_store -r "+backupPath+"/"+backupName+".sql");
    ...
    private void initComponents() {
        ...
        jButton6.setRolloverIcon(new javax.swing.ImageIcon(getClass().getResource("/Pics/btnMin.jpg"))); // NOI18N
        jButton6.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButton6ActionPerformed(evt);
            }
        });
        getContentPane().add(jButton6, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 10, 18, 20));
