...
public class frmUsers extends javax.swing.JFrame {
    ...
    @SuppressWarnings("unchecked")
     ...
     //Method to show data once starting the app
      ...
      //Put the first data from the database to the jtable
         RS.first();
         model.addRow(new Object[]{RS.getString("usr_ID"),RS.getString("user_Name"),RS.getString("user_password")});
    ...
    private void initComponents() {
        ...
        getContentPane().add(jButton5, new org.netbeans.lib.awtextra.AbsoluteConstraints(580, 0, 18, 20));
