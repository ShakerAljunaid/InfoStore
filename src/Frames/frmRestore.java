...
public class frmRestore extends javax.swing.JFrame {
  ...
  private Timer t=null;
    ...
    private void initComponents() {
        ...
        Server.setForeground(new java.awt.Color(255, 255, 0));
        ...
        jButton5.setRolloverIcon(new javax.swing.ImageIcon(getClass().getResource("/Pics/btnMin.jpg"))); // NOI18N
        jButton5.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButton5ActionPerformed(evt);
            }
        });
        getContentPane().add(jButton5, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 0, 18, 20));
