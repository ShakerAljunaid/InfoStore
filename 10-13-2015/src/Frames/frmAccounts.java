...
public class frmAccounts extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(285, 4, 70, -1));

        lblLink.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        getContentPane().add(lblLink, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 260, 120, 20));
        ...
        btnMin.setRolloverIcon(new javax.swing.ImageIcon(getClass().getResource("/Pics/btnMin.jpg"))); // NOI18N
        btnMin.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnMinActionPerformed(evt);
            }
        });
        getContentPane().add(btnMin, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 2, 18, 20));
    ...
    private void tblAccountsMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblAccountsMouseClicked
        ...
        try {
             int i = tblAccounts.getSelectedRow();
              index=i+1 ; 
            update_frame();
        } catch (SQLException ex) {
            Logger.getLogger(frmAccounts.class.getName()).log(Level.SEVERE, null, ex);
