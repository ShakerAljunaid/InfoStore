 ...
 */
public class BlogsTab_operations {
    ...
    //Method to show the data existing in the subject table
         ...
         * @throws SQLException
         */
        public ResultSet show_blogs() throws SQLException
               
       {
           //Call the stored procedure designated for showing subjets
           CallableStatement cstm=dbconn.prepareCall("{call show_blogs}");
       ...
       public ResultSet add_new(Date now) throws SQLException
     {
         ...
         CallableStatement cstm=dbconn.prepareCall("{call add_new_blog(?)}");
         cstm.setDate(1, now);
           //Execute the stored procedure and put the result into data set 
           ResultSet RS=cstm.executeQuery();
            //Return the data set 
        ...
        * @throws SQLException
        */
       public  ResultSet update_blogs(int updatedRow, String[] textboxes) throws SQLException
        {
             
            // Call the stored procedure designated for updating subject data
         
          CallableStatement cstm=dbconn.prepareCall("{call update_blog(?,?,?)}");
      ...
      //Method to delete data from the subject table
         ...
         * @throws SQLException
         */
        public  ResultSet delete_blogs(int deletedRow) throws SQLException
        {
             
            // Call the stored procedure designated for deleting subject
         
          CallableStatement cstm=dbconn.prepareCall("{call delete_blog(?)}");
          //Setting the in parameteres for the stored procedure in the same order of the procedure
         ...
         * @throws SQLException
         */
        public ResultSet search_blogs(String criterion) throws SQLException
       {
         // Call the stored procedure designated for search subject
         
          CallableStatement cstm=dbconn.prepareCall("{call Search_blogs(?)}");
          //Setting the in parameteres for the stored procedure in the same order of the procedure
