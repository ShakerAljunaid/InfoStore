...
public class frmUsers extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txtName.setBackground(new java.awt.Color(241, 245, 250));
        txtName.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        txtName.setBorder(null);
        getContentPane().add(txtName, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 80, 100, 30));
        ...
        txtID.setBackground(new java.awt.Color(204, 255, 102));
        txtID.setEditable(false);
        txtID.setBorder(null);
        getContentPane().add(txtID, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 300, 60, 20));

        txtPassword.setBackground(new java.awt.Color(241, 245, 250));
        txtPassword.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        txtPassword.setBorder(null);
        getContentPane().add(txtPassword, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 125, 130, 30));

        lblTry.setText("jLabel2");
        getContentPane().add(lblTry, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 200, -1, -1));
                ...
                try {
                    ...
                    if(usrOp.check_replication(txtUserName.getText()))
                    {
                     try {
                               ...
                               index=Integer.valueOf(idbo.show_total(usr_RS));
                                 lblTotal1.setText(String.valueOf(index));
                                   ...
                                   lblID.setVisible(true);
                                    set_Editcomponents(true);
                                  JOptionPane.showMessageDialog(null, "! Insertion Done successfully ! ", "information", JOptionPane.OK_OPTION);  
                         ...
                         { JOptionPane.showMessageDialog(null, "! The name is already existting ! ", "warning", JOptionPane.OK_OPTION); 
                         Reset_textboxex();
                         txtUserName.setText("");
                         }
                   ...
                   {      JOptionPane.showMessageDialog(null, "The confirm not match the password ", "information", JOptionPane.OK_OPTION);
                       txtConfirm.setText("");
                    }   
            }
            //Else the all components not filled then alert the user
            else
             JOptionPane.showMessageDialog(null, "You must fill all textboxes ", "information", JOptionPane.OK_OPTION);
                           
    }//GEN-LAST:event_btnOkActionPerformed

    private void btnCancelActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCancelActionPerformed
        try {
            JOptionPane.showMessageDialog(null, "The operation cancelled ", "information", JOptionPane.OK_OPTION);
                 update_frame();
                 show_table(usr_RS);
                 txtConfirm.setText("");
                  set_OK_canel (false);
                    ...
                    if (!txtUserName.getText().equals(currentName))
                     ...
                     //Call the method designated for update
                                 ...
                                 set_OK_canel (false);
                                  set_Editable(false);
                                  txtConfirm.setText("");
                                 JOptionPane.showMessageDialog(null, "! update Done successfully ! ", "information", JOptionPane.OK_OPTION);  
                                  txtUser_ID.setVisible(true);
                                  lblID.setVisible(true);
                                    set_Editcomponents(true);
                                    } catch (SQLException ex) { Logger.getLogger(frmUsers.class.getName()).log(Level.SEVERE, null, ex);}  
                            ...
                            //Else the name is replicated
                              ...
                              { JOptionPane.showMessageDialog(null, "! The name is already existing ! ", "warning", JOptionPane.OK_OPTION); 
                                Reset_textboxex();
